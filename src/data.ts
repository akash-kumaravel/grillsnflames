...
export const PROJECTS: Project[] = [
  {
    ...
    category: 'kitchen',
    heroImage: '/assets/OutdoorKitchenBa service.png',
    ...
    gallery: [
      '/assets/OutdoorKitchenBa service.png',
      '/assets/OutdoorKitchenShowcas.png',
      '/assets/BBQStationPhot.png'
    ],
    specs: [
  ...
  },
  {
    ...
    category: 'fire',
    heroImage: '/assets/SunkenFireLoung service .png',
    ...
    gallery: [
      '/assets/SunkenFireLoung service .png',
      '/assets/FirepitNearPool.png',
      '/assets/IndoorFirepitShowcas.png'
    ],
    specs: [
  ...
  },
  {
    ...
    category: 'pavilion',
    heroImage: '/assets/BioclimaticPergolaPavilio service.png',
    ...
    gallery: [
      '/assets/BioclimaticPergolaPavilio service.png',
      '/assets/PergolaShowcas.png',
      '/assets/OutdoorKitchenShowcas.png'
    ],
    specs: [
  ...
  },
  {
    ...
    category: 'kitchen',
    heroImage: '/assets/CompactKitchen_Smoke service.png',
    ...
    gallery: [
      '/assets/CompactKitchen_Smoke service.png',
      '/assets/BBQStationPhot.png',
      '/assets/OutdoorKitchenBa service.png'
    ],
    specs: [
  ...
  },
  {
    ...
    category: 'fire',
    heroImage: '/assets/FloatingFireBow service.png',
    ...
    gallery: [
      '/assets/FloatingFireBow service.png',
      '/assets/DecorativeFireBowl.png',
      '/assets/FirepitNearPool.png'
    ],
    specs: [
  ...
  },
  {
    ...
    location: 'Jumeirah Golf Estates, Dubai',
    category: 'pavilion',
    heroImage: '/assets/LuxuryPergola_Rotisseri service.png',
    ...
    gallery: [
      '/assets/LuxuryPergola_Rotisseri service.png',
      '/assets/PergolaShowcas.png',
      '/assets/BioclimaticPergolaPavilio service.png'
    ],
    specs: [
...
export const SERVICES_LIST: ServiceDetail[] = [
  ...
  },
  {
    ...
    image: '/assets/outdoor firepit.jpg',
  ...
  },
  {
    ...
    image: '/assets/indoor fire pit.jpg',
  ...
  },
  {
    ...
    image: '/assets/decorative fire bowl .jpg',
    ...
    gallery: [
      '/assets/decorative fire bowl .jpg',
      '/assets/FloatingFireBow service.png',
      '/assets/DecorativeFireBowl.png'
    ],
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Built-in outdoor wine cellars, ice makers, and automated dishwashers',
      'Integrated breakfast bar islands designed for poolside entertainment'
    ]
  }
];
